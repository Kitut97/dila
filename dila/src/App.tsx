      ...
      <header className="hero">
        ...
        <div className="hero-portrait">
          <div className="hero-portrait-inner">
            <img src="/dila imgae/dila 1.jpeg" alt="Dila close-up dengan senyum lembut" />
